...
st.text("<h3 style='text-align: left; '>The real estate valuation is a regression problem. The market historical data set of real estate valuation are collected from Sindian Dist., New Taipei City, Taiwan. </h3>')
st.markdown('---'*10)
