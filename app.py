...
st.write= ("<h3 style='text-align: center;'>The real estate valuation is a regression problem. The market historical data set of real estate valuation are collected from Sindian Dist, New Taipei City, Taiwan.</h3>", unsafe_allow_html=True)     
st.markdown('---'*10)
